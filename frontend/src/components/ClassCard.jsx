...
export default function ClassCard({ cls, status = 'other', onEdit, onDelete }) {
  ...
  const statusStyles = {
    ...
    upcoming: 'bg-white/95 dark:bg-[#0d1222]/75 backdrop-blur-md shadow-sm dark:shadow-[0_8px_25px_rgba(0,0,0,0.45)] hover:dark:shadow-[0_12px_32px_rgba(0,0,0,0.65),0_0_20px_rgba(59,130,246,0.12)]',
    ended: 'bg-gray-50/90 dark:bg-[#0d1222]/40 backdrop-blur-sm opacity-75 shadow-none',
  ...
  return (
    <>
      <motion.div 
        ...
        className={`relative rounded-2xl border border-gray-200/80 dark:border-gray-800/80 p-4 transition-shadow duration-200 ${statusStyles[status] || statusStyles.other}`}
      >
        ...
        <div className="flex items-center justify-between gap-3 mb-2.5">
          ...
          <div className="flex items-center gap-1.5 shrink-0">
            ...
            <motion.button
              ...
              className="relative flex items-center gap-1 p-1.5 rounded-lg text-gray-400 hover:text-amber-500 hover:bg-amber-50 dark:hover:bg-amber-950/20 transition-colors"
        ...
        {/* Highlighted Details: Class Time and Class Room */}
        ...
        {/* Expandable "More details" section with smooth AnimatePresence */}
        <AnimatePresence>
          {showDetails && (
            <motion.div 
              ...
              className="mt-3 pt-3 border-t border-dashed border-gray-200 dark:border-gray-800/80 space-y-2 overflow-hidden"
            >
